...
que ya usa fase4_cursor.py para el mouse gestual (agente/ no lo importa --
se reescribe la parte minima que hace falta, ver CLAUDE.md sobre el
principio de aislamiento entre agente/ y fase1-4).
